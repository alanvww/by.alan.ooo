...
export function MDXImage({ src, alt, caption, width, height }: MDXImageProps) {
  ...
  return (
    <figure className="my-10 group relative rounded-xl overflow-hidden border border-xmb-fg/10 bg-xmb-fg/5 shadow-2xl transition-all duration-500 hover:border-xmb-fg/30">
