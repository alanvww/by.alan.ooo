...
// Custom MDX components styled for XMB interface
export const xmbMdxComponents: MDXComponents = {
    h1: ({ children, ...props }) => (
    ...
    code: ({ children, className, ...props }: { children: string, className?: string, [key: string]: any }) => {
        ...
        // Use the existing CodeBlock but maybe we'll want to style it more later
        return (
    ...
    // Pass-through standard components but ensure they work in XMB context
    Alert,
    Callout,
    Card,
    Figure,
